...
void loop()
{
 ...
 // Serial.println((float)(alt) / 30.48);
  ...
  long Press = baro.getPresiune(); 
  //Serial.print("Temperature: "); 
  //Serial.println(temp);
  delay(100);
  int altG = gps.f_altitude(); 
  String dataStringPressure = "Pascals: " + String(Press);
...
String dataStringTOT = dataStringx + "," + dataStringy + "," + dataStringz;
  ...
  SenzorCo2();
  SenzorO3();
  String Codoi = " #2(New)-O3: " + String(Co2);
  String Otrei = " #1(Original)-O3: " + String(O3);
  ...
  dataString = SD_date_time + "," + SD_lat + "," + SD_lon + "," + dataStringALT + "," + dataStringTEMP + "," + dataStringALTG + "," + dataStringTOT + "," + Gaze + "," + Alimentare + "," + dataStringPressure;
  ...
  File dataFile = SD.open("Ozone2.csv", FILE_WRITE);
  if (dataFile)
  {
...
void SendTextMessage()
{
  ...
  delay(100);
  mySerial.println("AT + CMGS = \"+14258983171\"");//send sms message, be careful need to add a country code before the cellphone number
  delay(100);
